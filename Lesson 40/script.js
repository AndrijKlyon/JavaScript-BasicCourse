...
console.log("pc3 prototype:", Object.getPrototypeOf(pc3));
...
class Desktop extends PC {
  constructor(processor, processorModel, ram, ssd, videoCard) {
    super(processor, processorModel, ram, ssd);
...
console.log("pc5 instanceof PC:", pc5 instanceof PC);
...
console.log("pet3 type:", pet3.type);
